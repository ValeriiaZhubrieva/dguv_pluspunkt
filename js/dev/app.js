...
function initSliders() {
  if (document.querySelector(".reports-block__slider")) {
    const reportsSliders = document.querySelectorAll(".reports-block__slider");
    reportsSliders.forEach((slider) => {
      new Swiper(slider, {
        modules: [Navigation],
        observer: true,
        observeParents: true,
  ...
  if (document.querySelector(".proposals__slider")) {
    const proposalsSlider = document.querySelectorAll(".proposals__slider");
    proposalsSlider.forEach((slider) => {
